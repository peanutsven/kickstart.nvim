...
-- neovim venv for python
vim.g.python3_host_prog = '/home/svk/.virtualenvs/neovim/bin/python'
...
-- Navigate buffers
vim.keymap.set('n', '<S-l>', ':bnext<CR>', { desc = 'Buffer left' })
vim.keymap.set('n', '<S-h>', ':bprevious<CR>', { desc = 'Buffer right' })
...
vim.keymap.set('i', 'jk', '<ESC>', { desc = 'fast ESC with jk' })
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'python', 'puppet', 'query', 'vim', 'vimdoc' },
